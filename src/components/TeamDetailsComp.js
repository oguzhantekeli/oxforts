...
import { certificate_1_1, certificate_1_2, team_d_1 } from "../images/images";
const TeamDetailsComp = () => {
  return (
    <>
            ...
            <div className="col-lg-5">
              <div className="team-details__content">
                ...
                <ul className="list-unstyled team-details__certificate-list">
                  <li>
                    <img src={certificate_1_1} alt="" />
                  </li>
                  <li>
                    <img src={certificate_1_2} alt="" />
                  </li>
                </ul>
